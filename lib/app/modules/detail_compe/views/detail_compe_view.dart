...
class DetailCompeView extends GetView<DetailCompeController> {
  const DetailCompeView({super.key});
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () => controller.handleGetData(id: controller.getInitData().compeId),
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            onPressed: controller.handleJoinGroup,
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: controller.handleCreateGroup,
                            style: ElevatedButton.styleFrom(
                              padding: EdgeInsets.symmetric(
                                vertical: 12,
                              ),
